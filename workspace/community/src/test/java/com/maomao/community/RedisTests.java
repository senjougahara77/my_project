...
public class RedisTests {
    ...
    public void testHash() {
        ...
        redisTemplate.opsForHash().put(redisKey, "usrname", "zs");

        System.out.println(redisTemplate.opsForHash().get(redisKey, "id"));
        System.out.println(redisTemplate.opsForHash().get(redisKey, "usrname"));
    }
    ...
    @Test
    public void testSet() {
        String redisKey = "test:t";

        redisTemplate.opsForSet().add(redisKey, 1, 2, 413, 34, 43);
